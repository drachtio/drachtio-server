...
RUN apt-get update \
  ...
  && apt-get install -y --no-install-recommends ca-certificates gcc g++ make cmake build-essential cmake git autoconf automake  curl libtool libtool-bin libssl-dev libcurl4-openssl-dev zlib1g-dev net-tools nmap netcat iputils-ping traceroute \
